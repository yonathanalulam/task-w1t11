...
### 1) Medium — CSRF enforcement excludes public mutating auth endpoints
...
### 2) Medium — Question-bank image upload type validation trusts client metadata
- Conclusion: **Partial Fail**
...
### 3) Low — No dedicated integration test for reserved human-verification endpoint contract
